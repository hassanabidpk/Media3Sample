...
import com.hassan.media3sample.databinding.ActivityCameraMainBinding

class CameraMainActivity : AppCompatActivity() {

    private lateinit var activityMainBinding: ActivityCameraMainBinding
    @SuppressLint("SourceLockedOrientationActivity")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        activityMainBinding = ActivityCameraMainBinding.inflate(layoutInflater)
