...
val snacks = listOf(
    ...
    Snack(
        ...
        name = "Char Kuey Teow",
        tagline = "Noodles",
        imageUrl = "https://source.unsplash.com/UXzx4Q3yeXo",
        price = 299
    ),
    Snack(
        id = 30L,
        name = "Chendol",
        tagline = "Dessert",
        imageUrl = "https://source.unsplash.com/EzeobegRjcw",
        price = 299
    ),
    Snack(
        id = 32L,
        name = "Dim sum",
        tagline = "Food",
        imageUrl = "https://source.unsplash.com/vJH9GYZ-9dk",
        price = 299
    ),
    Snack(
        id = 32L,
        name = "Asam Laksa",
        tagline = "Noodles",
        imageUrl = "https://3.bp.blogspot.com/-GjfaSKMCMKs/Tnf51by8-MI/AAAAAAAACZY/6JcsB62LeXQ/s1600/Penang+asam+laksa.JPG",
        price = 299
    ),
    Snack(
        id = 33L,
        name = "Chilli Crab",
        tagline = "Seafood",
        imageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcST3bOLMdUFM1EPamKXjtkJK4P5aKzTe7dCrnd3ztDj5ksOxUXPhC0ygNcWhDtNa1bEBDA&usqp=CAU",
        price = 299
    ),
    Snack(
        id = 34L,
        name = "Chicken Rice",
        tagline = "Rice",
        imageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFlqE68g9rwNMxovBSzQaP7bsS01zaLpjpqGMYCm25evBjJ9wJwuPU1XVr1dqvW7PVC80&usqp=CAU",
        price = 299
    ),
    Snack(
        id = 35L,
        name = "Kaya Toast",
        tagline = "Breakfast",
        imageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdL0BpCRp93SjmZpWsW-qZgUpa-7Bgxus1AqdzKBw_kEsN-6tfYy66LD0l9zOQu2J4E6Q&usqp=CAU",
        price = 299
    ),
)
