...
private val wfhFavs = SnackCollection(
    id = 3L,
    type = CollectionType.Highlight,
    name = "Penang favourites",
    snacks = snacks.subList(28, 32)
)
...
private val exclusive = SnackCollection(
    id = 5L,
    name = "Singapore favourites",
    snacks = snacks.subList(32, 35)
)
